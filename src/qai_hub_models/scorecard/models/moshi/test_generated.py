...
from qai_hub_models.models.moshi import Model, MODEL_ID
...
from qai_hub_models.utils.export.inference import run_collection_inference as inference_model
from qai_hub_models.utils.export.quantize import run_collection_quantize as quantize_model
...
import qai_hub_models.models.moshi as _model_module
...
@pytest.mark.parametrize(("precision", "scorecard_path", "device"), get_compile_parameterized_pytest_config(MODEL_ID, ENABLED_PRECISION_RUNTIMES, PASSING_PRECISION_RUNTIMES), ids=pytest_device_idfn)
@pytest.mark.compile
...
@pytest.mark.parametrize(("precision", "scorecard_path", "device"), get_link_parameterized_pytest_config(MODEL_ID, ENABLED_PRECISION_RUNTIMES, PASSING_PRECISION_RUNTIMES), ids=pytest_device_idfn)
@pytest.mark.link
def test_link(precision: Precision, scorecard_path: ScorecardCompilePath, device: ScorecardDevice) -> None:
    ...
    try:
        ...
        pytest.skip(str(e))
@pytest.mark.parametrize(("precision", "scorecard_path", "device"), get_profile_parameterized_pytest_config(MODEL_ID, ENABLED_PRECISION_RUNTIMES, PASSING_PRECISION_RUNTIMES), ids=pytest_device_idfn)
@pytest.mark.profile
def test_profile(precision: Precision, scorecard_path: ScorecardProfilePath, device: ScorecardDevice) -> None:
    ...
    try:
        ...
        pytest.skip(str(e))
@pytest.mark.parametrize(("precision", "scorecard_path", "device"), get_evaluation_parameterized_pytest_config(MODEL_ID, EVAL_DEVICE, ENABLED_PRECISION_RUNTIMES, PASSING_PRECISION_RUNTIMES, ), ids=pytest_device_idfn)
...
@pytest.mark.parametrize(("precision", "scorecard_path", "device"), get_export_parameterized_pytest_config(MODEL_ID, EVAL_DEVICE, ENABLED_PRECISION_RUNTIMES, PASSING_PRECISION_RUNTIMES, requires_aot_prepare=True, ), ids=pytest_device_idfn)
@pytest.mark.export
